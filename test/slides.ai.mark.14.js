...
[
	{
		target: "トゥッ　コ　オカケタ　カマクㇱ　マラプト、　パンダネ　サㇰ　パン　マラプト　アン;　オロワ、　カムイ　コラ　ケンル　エサパネ　ウタラ　ネワ、　カㇺピ　ヌイェ　ウタラ　アナㇰ　ネ　ヌイナノ　シヌマ　キシマ　ワ　ライゲ　クニ　フナラ　ルウェ　ネ:",
		alt: "Tut ko okaketa Kamakus marapto, Pandane sak pan marapto an; orowa, Kamui kora kenru esapane utara newa, kampi nuye utara anak ne nuinano sinuma kisima wa raige kuni hunara ruwe ne:",
		...
		words: [ 'トゥッ', 'コ', 'オカケタ', 'カマクㇱ', 'マラプト', 'パンダネ', 'サㇰ', 'パン', 'マラプト', 'アン', 'オロワ', 'カムイ', 'コラ', 'ケンル', 'エサパネ', 'ウタラ', 'ネワ', 'カㇺピ', 'ヌイェ', 'ウタラ', 'アナㇰ', 'ネ', 'ヌイナノ', 'シヌマ', 'キシマ', 'ワ', 'ライゲ', 'クニ', 'フナラ', 'ルウェ', 'ネ' ],
		audio: "./rsrc/ai/Mark/14/audio/120/0.wav",
		quizWords: [ 'カマクㇱ', 'パンダネ', 'マラプト' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/1.wav",
		quizWords: [ 'サカヨ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/2.wav",
		quizWords: [ 'タスㇺ', 'ラポケタ', 'セイ', 'ムニン', 'ペレケ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/3.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/4.wav",
		quizWords: [ 'ワン', 'エアㇱカイベ', 'オテㇰサㇰ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/5.wav",
		quizWords: [ 'モシマノ', 'イキプ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/6.wav",
		quizWords: [ 'レンガイネ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/7.wav",
		quizWords: [ 'トゥシリ', 'ネトバケ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/8.wav",
		quizWords: [ 'エビッタ', 'エウパㇱクマ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/9.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/10.wav",
	...
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/11.wav",
		quizWords: [ 'エアッパケ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/12.wav",
		quizWords: [ 'オㇱ', 'オプ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/13.wav",
		quizWords: [ 'イェヒ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/14.wav",
		quizWords: [ 'ヌカレ', 'ソ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/15.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/16.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/17.wav",
		quizWords: [ 'シネン' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/18.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/19.wav",
		quizWords: [ 'ニマ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/20.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/21.wav",
		quizWords: [ 'パンタㇰ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/22.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/23.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/24.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/25.wav",
		quizWords: [ 'シノッチャキ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/26.wav",
	...
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/27.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/28.wav",
		quizSentence: true
	},
	{
		target: "オロタ　イェス　エネ　イタㇰヒ、　ソンノ　エ　オッタ　ク　イェ、　タント、　タン　ウクラン、　トゥ　スイネ　ニワトリ　チカプ　ハウ　コロ　エトコタ　エアニ　レ　スイ　ネ　エン　エㇱ　ヒナ　クス　ネ　ナ、　セコロ　イタㇰ。",
		alt: "Orota Yesu ene itakhi, Sonno e otta Ku ye, tanto, tan ukuran, tu suine niwatori cikap hau koro etokota eani re sui ne En es hina kusu ne na, sekoro itak.",
		...
		words: [ 'オロタ', 'イェス', 'エネ', 'イタㇰヒ', 'ソンノ', 'エ', 'オッタ', 'ク', 'イェ', 'タント', 'タン', 'ウクラン', 'トゥ', 'スイネ', 'ニワトリ', 'チカプ', 'ハウ', 'コロ', 'エトコタ', 'エアニ', 'レ', 'スイ', 'ネ', 'エン', 'エㇱ', 'ヒナ', 'クス', 'ネ', 'ナ', 'セコロ', 'イタㇰ' ],
		audio: "./rsrc/ai/Mark/14/audio/120/29.wav",
		quizWords: [ 'スイネ', 'タント', 'ニワトリ', 'ウクラン', 'スイ', 'エㇱ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/30.wav",
		quizWords: [ 'エシナ', 'ユプケ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/31.wav",
		quizSentence: true
	},
	{
		target: "オロワ、　シヌマ　アナㇰ　ネ　ペッロㇱ　ヘㇺヘㇺ、　ヤコブ　ヘㇺヘㇺ、　ヨアンネㇱ　ヘㇺヘㇺ、　トゥラ　ワ　パイェ、　アイネ、　シノ　キマテㇰ　ワ　ポロンノ　ラムオㇰ　ナタラ　ヘアシ　ニサ　ルウェ　ネ。",
		alt: "Orowa, sinuma anak ne Petros hemhem, Yakob hemhem, Yoannes hemhem, tura wa paye, aine, sino kimatek wa poronno ramuok natara heasi nisa ruwe ne.",
		native: "He took with him Peter, James, and John; and began to show signs of great dismay and deep distress of mind.",
		words: [ 'オロワ', 'シヌマ', 'アナㇰ', 'ネ', 'ペッロㇱ', 'ヘㇺヘㇺ', 'ヤコブ', 'ヘㇺヘㇺ', 'ヨアンネㇱ', 'ヘㇺヘㇺ', 'トゥラ', 'ワ', 'パイェ', 'アイネ', 'シノ', 'キマテㇰ', 'ワ', 'ポロンノ', 'ラムオㇰ', 'ナタラ', 'ヘアシ', 'ニサ', 'ルウェ', 'ネ' ],
		audio: "./rsrc/ai/Mark/14/audio/120/32.wav",
		quizWords: [ 'ナタラ', 'キマテㇰ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/33.wav",
		quizWords: [ 'シルウェ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/34.wav",
		quizWords: [ 'ヘチャカ', 'ポンノ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/35.wav",
		quizWords: [ 'ミチヒ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/36.wav",
		quizWords: [ 'モコロ' ]
	},
	{
		target: "シモン、　エ　モコ　ロ　ヤ？　シネ　パキヒ　エアニ　シウレ　エアイカプ　ヤ？　エチ　ウタラ　イテキ　アコラㇺヌカラ　クニ　ネ　シウレ　ワ　イノンノ　イタㇰ　キ　ヤン:　ラマッ　アナㇰ　ネ　キ　ルスイベ　ネ、　コロカ、　カㇺ　アナㇰ　カッチャㇰベ　ネ　ルウェ　ネ、　セコロ　イタㇰ。",
		alt: "Simon, e moko ro ya? sine pakihi eani siure eaikap ya? Eci utara iteki akoramnukara kuni ne siure wa inonno itak ki yan: ramat anak ne ki rusuibe ne, koroka, kam anak katcakbe ne ruwe ne, sekoro itak.",
		...
		words: [ 'シモン', 'エ', 'モコ', 'ロ', 'ヤ', 'シネ', 'パキヒ', 'エアニ', 'シウレ', 'エアイカプ', 'ヤ', 'エチ', 'ウタラ', 'イテキ', 'アコラㇺヌカラ', 'クニ', 'ネ', 'シウレ', 'ワ', 'イノンノ', 'イタㇰ', 'キ', 'ヤン', 'ラマッ', 'アナㇰ', 'ネ', 'キ', 'ルスイベ', 'ネ', 'コロカ', 'カㇺ', 'アナㇰ', 'カッチャㇰベ', 'ネ', 'ルウェ', 'ネ', 'セコロ', 'イタㇰ' ],
		audio: "./rsrc/ai/Mark/14/audio/120/37.wav",
		quizWords: [ 'シウレ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/38.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/39.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/40.wav",
		quizWords: [ 'シニ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/41.wav",
		quizWords: [ 'ヘタㇰ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/42.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/43.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/44.wav",
		quizSentence: true
	},
	{
		target: "オロワノ、　オカイ　ウタラ　テケ　アニ　イェス　キシナ　ルウェ　ネ。",
		alt: "Orowano, okai utara teke ani Yesu kisina ruwe ne.",
		native: "Then the men seized Jesus, and arrested him.",
		words: [ 'オロワノ', 'オカイ', 'ウタラ', 'テケ', 'アニ', 'イェス', 'キシナ', 'ルウェ', 'ネ' ],
		audio: "./rsrc/ai/Mark/14/audio/120/45.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/46.wav",
	...
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/47.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/48.wav",
		quizWords: [ 'カㇺピソㇱ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/49.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/50.wav",
		quizWords: [ 'センカキ', 'アトゥサ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/51.wav",
		quizWords: [ 'アンデ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/52.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/53.wav",
		quizWords: [ 'イピシ', 'ヤイポプケレ', 'トゥイマノ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/54.wav",
	...
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/55.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/56.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/57.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/58.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/59.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/60.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/61.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/62.wav",
		quizWords: [ 'モシマ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/63.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/64.wav",
		quizWords: [ 'コキㇰ', 'トプセ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/65.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/66.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/67.wav",
		quizWords: [ 'ラメパカリ', 'セㇺ' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/68.wav",
		quizSentence: true
	},
	{
		target: "コロカ、　カンナ　スイ　シヌマ　ネイ　アㇺベ　エㇱ　ヒナ　ニサ　ルウェ　ネ。　サマタ、　ナア　ポンノ　シラン　コロ、　サマケタ　ロㇱキ　ワ　オカイ　ウタラ　アナㇰ　ネ　ペッロㇱ　オッタ　エネ　イタㇰヒ、　ソンノ　ポカ　エアニ　ネイ　ウタラ　ウン　シネン　エ　ネ;　エアニ、　ガリラヤ　ウン　グル　エ　ネ　ルウェ　ネ　クス　ネ　ナ、　セコロ　イタㇰ。",
		alt: "Koroka, kanna sui sinuma ney ambe es hina nisa ruwe ne. Samata, naa ponno siran koro, samaketa roski wa okai utara anak ne Petros otta ene itakhi, Sonno poka eani ney utara un sinen e ne; eani, Gariraya un guru e ne ruwe ne kusu ne na, sekoro itak.",
		...
		words: [ 'コロカ', 'カンナ', 'スイ', 'シヌマ', 'ネイ', 'アㇺベ', 'エㇱ', 'ヒナ', 'ニサ', 'ルウェ', 'ネ', 'サマタ', 'ナア', 'ポンノ', 'シラン', 'コロ', 'サマケタ', 'ロㇱキ', 'ワ', 'オカイ', 'ウタラ', 'アナㇰ', 'ネ', 'ペッロㇱ', 'オッタ', 'エネ', 'イタㇰヒ', 'ソンノ', 'ポカ', 'エアニ', 'ネイ', 'ウタラ', 'ウン', 'シネン', 'エ', 'ネ', 'エアニ', 'ガリラヤ', 'ウン', 'グル', 'エ', 'ネ', 'ルウェ', 'ネ', 'クス', 'ネ', 'ナ', 'セコロ', 'イタㇰ' ],
		audio: "./rsrc/ai/Mark/14/audio/120/69.wav",
		quizWords: [ 'シラン' ]
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/70.wav",
		quizSentence: true
	},
	{
		...
		audio: "./rsrc/ai/Mark/14/audio/120/71.wav",
		quizWords: [ 'エシカルン' ]
	}
];