...
[
	...
	},
	{
		...
		words: [ '我们', '称', '它', '沃特坎普夫', '测试' ]
	},
	{
		target: "戴克先生 这是艾尔顿 泰里尔博士。",
		alt: "Dàikè　xiānshēng　zhè　shì　àiěrdùn　tàilǐěr　bóshì。",
		native: "Mr. Dyke This is Dr. Elton Tyrell.",
		words: [ '戴克', '先生', '这', '是', '艾尔顿', '泰里尔', '博士' ]
	},
	{
		target: "示范一下。",
		alt: "Shìfàn　yīxià。",
	...
	},
	{
		...
		native: "Because their life span is too short to accumulate experience that you and I take for granted.",
		words: [ '因为', '他们', '的', '寿命', '太', '短', '不足', '以', '积累', '经验', '这', '一点', '你', '我', '都', '能', '保证' ],
		quizWords: [ '保证', '短', '积累', '经验' ]
	},
	{
